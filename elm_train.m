function [TrainingTime,TrainingAccuracy,Y] = elm_train(TrainingData_File, Elm_Type, NumberofHiddenNeurons, ActivationFunction)
% First column = Target, 2nd column = data
% save('250hz.txt', 'X_250', '-ASCII','-append');
%
...
%
% Sample1 regression: [TrainingTime, TrainingAccuracy, Y] = elm_train('sinc_train.txt', 0, 20, 'sig');
% Sample2 classification:   [TrainingTime, TrainingAccuracy,Y] = elm_train('diabetes_train.txt', 1, 20, 'sig');
%
...
T=train_data(:,14:17)';
P=train_data(:,1:size(train_data,2)-4)';
